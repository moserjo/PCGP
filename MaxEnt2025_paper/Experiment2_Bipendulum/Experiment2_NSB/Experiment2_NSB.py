...
class PCGP_Kernel(gpytorch.kernels.Kernel):
    def __init__(self, input_parameters, number_of_input_dimensions=1, num_tasks=3, **kwargs):
        super().__init__()
    ...
    def forward(self, x1, x2, diag=False, **params):
        ...
        l2 = self.get_param('l2')
        k00 = A*(g**2*l**4 - 2*g*l**2*l2*(l - (xx[0] - yy[0])**2) + l2**2*(2*l**2 - 4*l*(xx[0] - yy[0])**2 + (l - (xx[0] - yy[0])**2)**2))*torch.exp(-1/2*(xx[0] - yy[0])**2/l)/l**4
        k01 = A*(g**2*l**4 - g*l**2*(l - (xx[0] - yy[0])**2)*(l1 + l2) + l1*l2*(2*l**2 - 4*l*(xx[0] - yy[0])**2 + (l - (xx[0] - yy[0])**2)**2))*torch.exp(-1/2*(xx[0] - yy[0])**2/l)/l**4
        k02 = A*(g**3*l**6 - g**2*l**4*(l - (xx[0] - yy[0])**2)*(l1 + 2*l2) + g*l**2*l2*(l1*(2*l**2 - 4*l*(xx[0] - yy[0])**2 + (l - (xx[0] - yy[0])**2)**2) + l1*(3*l**2 - 6*l*(xx[0] - yy[0])**2 + (xx[0] - yy[0])**4) + l2*(2*l**2 - 4*l*(xx[0] - yy[0])**2 + (l - (xx[0] - yy[0])**2)**2)) - l1*l2**2*(12*l**3 - 12*l**2*(xx[0] - yy[0])**2 + 8*l*(-3*l + (xx[0] - yy[0])**2)*(xx[0] - yy[0])**2 + (l - (xx[0] - yy[0])**2)*(3*l**2 - 6*l*(xx[0] - yy[0])**2 + (xx[0] - yy[0])**4)))*torch.exp(-1/2*(xx[0] - yy[0])**2/l)/l**6
        k10 = A*(g**2*l**4 - g*l**2*(l - (xx[0] - yy[0])**2)*(l1 + l2) + l1*l2*(2*l**2 - 4*l*(xx[0] - yy[0])**2 + (l - (xx[0] - yy[0])**2)**2))*torch.exp(-1/2*(xx[0] - yy[0])**2/l)/l**4
        k11 = A*(g**2*l**4 - 2*g*l**2*l1*(l - (xx[0] - yy[0])**2) + l1**2*(2*l**2 - 4*l*(xx[0] - yy[0])**2 + (l - (xx[0] - yy[0])**2)**2))*torch.exp(-1/2*(xx[0] - yy[0])**2/l)/l**4
        k12 = A*(g**3*l**6 - g**2*l**4*(l - (xx[0] - yy[0])**2)*(2*l1 + l2) + g*l**2*l1*(l1*(2*l**2 - 4*l*(xx[0] - yy[0])**2 + (l - (xx[0] - yy[0])**2)**2) + l2*(2*l**2 - 4*l*(xx[0] - yy[0])**2 + (l - (xx[0] - yy[0])**2)**2) + l2*(3*l**2 - 6*l*(xx[0] - yy[0])**2 + (xx[0] - yy[0])**4)) - l1**2*l2*(12*l**3 - 12*l**2*(xx[0] - yy[0])**2 + 8*l*(-3*l + (xx[0] - yy[0])**2)*(xx[0] - yy[0])**2 + (l - (xx[0] - yy[0])**2)*(3*l**2 - 6*l*(xx[0] - yy[0])**2 + (xx[0] - yy[0])**4)))*torch.exp(-1/2*(xx[0] - yy[0])**2/l)/l**6
        k20 = A*(g**3*l**6 - g**2*l**4*(l - (xx[0] - yy[0])**2)*(l1 + 2*l2) + g*l**2*l2*(l1*(2*l**2 - 4*l*(xx[0] - yy[0])**2 + (l - (xx[0] - yy[0])**2)**2) + l1*(3*l**2 - 6*l*(xx[0] - yy[0])**2 + (xx[0] - yy[0])**4) + l2*(2*l**2 - 4*l*(xx[0] - yy[0])**2 + (l - (xx[0] - yy[0])**2)**2)) - l1*l2**2*(12*l**3 - 12*l**2*(xx[0] - yy[0])**2 + 8*l*(-3*l + (xx[0] - yy[0])**2)*(xx[0] - yy[0])**2 + (l - (xx[0] - yy[0])**2)*(3*l**2 - 6*l*(xx[0] - yy[0])**2 + (xx[0] - yy[0])**4)))*torch.exp(-1/2*(xx[0] - yy[0])**2/l)/l**6
        k21 = A*(g**3*l**6 - g**2*l**4*(l - (xx[0] - yy[0])**2)*(2*l1 + l2) + g*l**2*l1*(l1*(2*l**2 - 4*l*(xx[0] - yy[0])**2 + (l - (xx[0] - yy[0])**2)**2) + l2*(2*l**2 - 4*l*(xx[0] - yy[0])**2 + (l - (xx[0] - yy[0])**2)**2) + l2*(3*l**2 - 6*l*(xx[0] - yy[0])**2 + (xx[0] - yy[0])**4)) - l1**2*l2*(12*l**3 - 12*l**2*(xx[0] - yy[0])**2 + 8*l*(-3*l + (xx[0] - yy[0])**2)*(xx[0] - yy[0])**2 + (l - (xx[0] - yy[0])**2)*(3*l**2 - 6*l*(xx[0] - yy[0])**2 + (xx[0] - yy[0])**4)))*torch.exp(-1/2*(xx[0] - yy[0])**2/l)/l**6
        k22 = A*(g**4*l**8 - 2*g**3*l**6*(l - (xx[0] - yy[0])**2)*(l1 + l2) + g**2*l**4*(l1**2*(2*l**2 - 4*l*(xx[0] - yy[0])**2 + (l - (xx[0] - yy[0])**2)**2) + 2*l1*l2*(2*l**2 - 4*l*(xx[0] - yy[0])**2 + (l - (xx[0] - yy[0])**2)**2) + 2*l1*l2*(3*l**2 - 6*l*(xx[0] - yy[0])**2 + (xx[0] - yy[0])**4) + l2**2*(2*l**2 - 4*l*(xx[0] - yy[0])**2 + (l - (xx[0] - yy[0])**2)**2)) - 2*g*l**2*l1*l2*(l1 + l2)*(12*l**3 - 12*l**2*(xx[0] - yy[0])**2 + 8*l*(-3*l + (xx[0] - yy[0])**2)*(xx[0] - yy[0])**2 + (l - (xx[0] - yy[0])**2)*(3*l**2 - 6*l*(xx[0] - yy[0])**2 + (xx[0] - yy[0])**4)) + l1**2*l2**2*(24*l**4 - 96*l**3*(xx[0] - yy[0])**2 + 72*l**2*(l - (xx[0] - yy[0])**2)**2 - 16*l*(3*l - (xx[0] - yy[0])**2)**2*(xx[0] - yy[0])**2 + (3*l**2 - 6*l*(xx[0] - yy[0])**2 + (xx[0] - yy[0])**4)**2))*torch.exp(-1/2*(xx[0] - yy[0])**2/l)/l**8
...
class PCGP_Model(gpytorch.models.ExactGP):
    def __init__(self, train_x, train_y, likelihood,  model_parameters, number_of_input_dimensions = 1, num_tasks = 3, priors = None):
